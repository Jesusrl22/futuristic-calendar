...
import { Calendar, Brain, Zap, Star, ArrowRight, Check } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
          Organize Your Life
          <br />
          <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">with AI</span>
        </h1>
      ...
      <section className="py-20 bg-black/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg p-6 hover:bg-white/10 transition-all">
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg p-6 hover:bg-white/10 transition-all">
              ...
              <p className="text-gray-400">Built-in focus timer to help you maintain productivity and avoid burnout</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            {/* Pro Plan */}
            <div className="bg-gradient-to-b from-purple-600/20 to-cyan-600/20 border border-purple-500/50 backdrop-blur-sm rounded-lg p-8 relative">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-purple-600 text-white rounded-full text-sm">
                Most Popular
              </div>
            ...
            <div className="bg-white/5 border border-white/10 backdrop-blur-sm rounded-lg p-8">
              ...
              <button className="w-full px-6 py-3 border border-purple-500 text-white hover:bg-purple-500/10 rounded-lg transition-colors">
                Contact Sales
              </button>
            </div>
          </div>
