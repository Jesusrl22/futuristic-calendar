export const translations = {
  en: {
    ...
    email: "Email",
    email_cannot_be_changed: "Your email cannot be changed",
    language: "Language",
    ...
    upgrade_for_more_themes: "Upgrade to Premium to unlock more themes",
    upgrade_for_custom_themes: "Upgrade to Pro to create custom themes",
    all_themes_available: "All themes are available for you",
    custom_theme_description: "Create your own custom color theme by selecting primary and secondary colors",
    primary_color: "Primary Color",
    secondary_color: "Secondary Color",
    pushNotifications: "Push Notifications",
    pushNotificationsDescription: "Receive notifications about tasks, achievements, and events",
    notificationsNotSupported: "Push notifications are not supported on this browser",
    ...
    pomodoro_work_duration: "Work Duration (minutes)",
    pomodoro_break_duration: "Break Duration (minutes)",
    pomodoro_long_break: "Long Break Duration (minutes)",
    save_settings: "Save Settings",
    settings_saved: "Settings saved successfully",
    success: "Success",
    verifiedReviewsTrustpilot: "Verified reviews from Trustpilot",
    seeAllReviews: "See All Reviews",
    viewAllReviewsDescription: "See all verified reviews from our users on Trustpilot",
    writeYourReview: "Write Your Review",
    writeReviewDescription: "Share your experience with Future Task on Trustpilot",
    
    // AI Quick Actions
    plan_my_day: "Plan My Day",
    plan_my_day_description: "AI creates a personalized schedule based on your tasks",
    prioritize_tasks: "Prioritize Tasks",
    prioritize_tasks_description: "AI organizes your tasks by importance and urgency",
