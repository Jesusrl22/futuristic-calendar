...
export const translations = {
  ...
  es: {
    ...
    confirmRemoveMember: "¿Estás seguro de que quieres remover este miembro?",
    ...
    memberActivity: "Actividad del Miembro",
    ...
    shareInvitationLink: "Comparte este enlace con el usuario para invitarlo al equipo",
    ...
    subscription_feature_shared_tasks: "Tareas compartidas del equipo",
  ...
  fr: {
    ...
    memberActivity: "Activité du Membre",
    totalTeamTasks: "Total des Tâches d'Équipe",
    ...
    subscription_feature_task_assignment: "Assignation de tâches",
  ...
  de: {
    ...
    invitationSent: "Einladung erfolgreich versendet",
    confirmRemoveMember: "Sind Sie sicher, dass Sie dieses Mitglied entfernen möchten?",
    memberPerformance: "Leistung des Mitglieds",
    completed: "Abgeschlossen",
    noTasksYet: "Noch keine Aufgaben",
    updateTeam: "Team aktualisieren",
    updating: "Wird aktualisiert...",
    ...
    totalTeamTasks: "Gesamte Team-Aufgaben",
    completedTeamTasks: "Abgeschlossene Aufgaben",
    ...
    copiedToClipboard: "Kopiert in Zwischenablage!",
    subscription_feature_team_collaboration_free: "Keine Team-Zusammenarbeit",
    subscription_feature_team_collaboration_premium: "3 Teams, 10 Mitglieder je Team",
    subscription_feature_team_collaboration_pro: "Unbegrenzte Teams und Mitglieder",
    subscription_feature_shared_tasks: "Gemeinsame Team-Aufgaben",
    subscription_feature_team_calendar: "Team-Kalender",
    subscription_feature_task_assignment: "Aufgabenzuweisung",
    subscription_feature_team_comments: "Kommentare zu Team-Aufgaben",
  ...
  it: {
    ...
    memberPerformance: "Prestazioni del Membro",
    completed: "Completato",
    noTasksYet: "Nessun'attività ancora",
    updateTeam: "Aggiorna Team",
    ...
    memberActivity: "Attività del Membro",
    totalTeamTasks: "Totale Attività del Team",
    completedTeamTasks: "Attività Completate",
    ...
    memberLimitReached: "Limite di membri raggiunto",
    upgradeToPremium: "Passa a Premium",
    upgradeToProForUnlimited: "Passa a Pro per illimitato",
    ...
    shareInvitationLink: "Condividi questo link con l'utente per invitarlo al team",
    copiedToClipboard: "Copiato negli appunti!",
    subscription_feature_team_collaboration_free: "Nessuna collaborazione di team",
    subscription_feature_team_collaboration_premium: "3 team, 10 membri ciascuno",
    subscription_feature_team_collaboration_pro: "Team e membri illimitati",
    subscription_feature_shared_tasks: "Attività condivise del team",
    subscription_feature_team_calendar: "Calendario del team",
    subscription_feature_task_assignment: "Assegnazione attività",
    subscription_feature_team_comments: "Commenti sulle attività del team",
