export const translations = {
  ...
  es: {
    ...
    email_cannot_be_changed: "El correo no puede ser cambiado",
    language: "Idioma",
    ...
    pomodoro_work_session_length: "Duración de la sesión de trabajo",
    pomodoro_break_duration: "Duración del Descanso",
    pomodoro_break_session_length: "Duración de la sesión de descanso",
    pomodoro_long_break: "Descanso Largo",
    pomodoro_long_break_length: "Duración del descanso largo (cada 4 ciclos)",
    minutes: "minutos",
  ...
  de: {
    ...
    language_german: "Deutsch",
    language_italian: "Italiano",
    timezone_region: "Zeitzone",
    current_time: "Aktuelle Zeit",
    theme: "Thema",
    theme_settings: "Themeneinstellungen",
    choose_theme: "Wähle ein Thema",
    ...
    pomodoro_work_session_length: "Dauer der Arbeitssitzung",
    pomodoro_break_duration: "Pausendauer",
    pomodoro_break_session_length: "Dauer der Pausensitzung",
    pomodoro_long_break: "Lange Pause",
    pomodoro_long_break_length: "Dauer der langen Pause (alle 4 Zyklen)",
    minutes: "Minuten",
  ...
  it: {
    ...
    email: "Email",
    email_cannot_be_changed: "L'email non può essere modificata",
    language: "Lingua",
    language_english: "English",
    language_spanish: "Español",
    language_french: "Français",
    ...
    pomodoro_duration: "Durata di Pomodoro",
    pomodoro_work_session_length: "Durata della sessione di lavoro",
    pomodoro_break_duration: "Durata della Pausa",
    pomodoro_break_session_length: "Durata della sessione di pausa",
    pomodoro_long_break: "Pausa Lunga",
    pomodoro_long_break_length: "Durata della pausa lunga (ogni 4 cicli)",
    minutes: "minuti",
