...
export const translations = {
  ...
  fr: {
    ...
    manage_subscription: "Gérez votre abonnement et votre facturation",
    plan_expires: "Le plan expire",
    credits: "crédits",
    cancel_subscription: "Annuler l'Abonnement",
    cancel_subscription_description:
      "Rétrograder au plan Gratuit. Vous conserverez les crédits achetés mais perdrez les crédits mensuels.",
    ...
    buy_extra_credits_description:
      "Achetez des crédits qui n'expirent jamais. Cumulez avec votre allocation mensuelle!",
    annual: "Annuel",
    ...
    subscription_feature_notes: "Fonction de notes",
    subscription_feature_wishlist: "Fonction de liste de souhaits",
    ...
    ai_assistant_upgrade_message: "Passez à Premium/Pro ou achetez des packs de crédits pour accéder à l'Assistant IA",
    ai_assistant_welcome: "Bienvenue dans votre Assistant IA",
    ai_assistant_cost: "Demandez-moi n'importe quoi! Chaque message coûte 2 crédits.",
    total_available: "Total disponible",
