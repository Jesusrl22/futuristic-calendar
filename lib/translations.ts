...
export const translations = {
  ...
  fr: {
    ...
    inviteMember: "Invite Member",
    copy: "Copy",
    anyoneWithThisLinkCanJoinTeam: "Anyone with this link can join the team",
    back: "Back",
    confirmRemoveMember: "Are you sure you want to remove this member?",
  ...
  de: {
    ...
    copy: "Kopieren",
    anyoneWithThisLinkCanJoinTeam: "Jeder mit diesem Link kann dem Team beitreten",
    back: "Zurück",
    confirmRemoveMember: "Sind Sie sicher, dass Sie dieses Mitglied entfernen möchten?",
    enterTeamName: "Bitte geben Sie den Teamnamen ein",
    saveChanges: "Änderungen Speichern",
    confirmDeleteTeam: "Sind Sie sicher, dass Sie das Team löschen möchten",
